								...
								<ul class="nav nav-main">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<li>
												<a href="candidates-payment-history.php">
													 Candidates Payment History
												</a>
											</li>
											<li>
												<a href="candidate-password.php">
													Change Password
												</a>
											</li>
										</ul>
