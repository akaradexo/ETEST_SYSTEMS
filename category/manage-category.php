						...
						<section class="panel">
							<header class="panel-heading">
								<div class="panel-actions">
   								...
   								<div class="row">
								   <h2 class="panel-title" style="display: inline-block;">Categories List</h2>
									<a type="button" style="float: right; margin-right: 80px;" class="btn btn-primary align-right"  href="add-category.php" >Add <i class="fa fa-plus"></i></a>
								</div>
							</header>
