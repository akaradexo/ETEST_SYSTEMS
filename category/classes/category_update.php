...
if(isset($_POST['Submit'])) {    
   ...
   // }    
    //else { 
        ...
        $result = $crud->execute("UPDATE `tbl_category` SET `category_name`=$categoryname,'department_name'=$departmentname,`created_by`=$email,`modified_by`=$email,`modified_date`=now() WHERE id = $id");
